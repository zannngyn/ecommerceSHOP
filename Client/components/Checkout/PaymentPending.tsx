    ...
    <div className='flex flex-col items-center w-screen'>
      ...
      <div className="bg-white flex items-center justify-center h-screen">
        <div className="bg-gray-50 border-2 flex gap-5 items-center flex-col text-gray-800 p-6 rounded-lg shadow-lg max-w-[90%] w-full text-center">
          ...
          <h2 className="text-2xl font-bold mb-2">Thanh toán đang chờ xác nhận</h2>
          <p className="mb-6">
            Thanh toán cho đơn hàng <span className="font-bold">#{params.orderID}</span> đang chờ xác nhận.
          </p>
          <p className="mb-6">
