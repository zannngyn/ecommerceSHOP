...
const ContactForm = () => {
    ...
    async function formSubmit(e: any) {
        ...
        switch (response.status) {
            case 200:
                setmessage(`#${response.data.id} - Gửi tin nhắn thành công, chúng tôi sẽ liên hệ bạn trong vòng 24 giờ. Cảm ơn bạn.`)
                setloading(false);
                break;

            default:
                setmessage('Chúng tôi gặp lỗi khi xử lý yêu cầu. Vui lòng thử lại sau.')
                setloading(false);
                break;
        }
    }
                    ...
                    <div className="lg:mb-0 mb-10">
                        <div className="group w-full h-full">
                            <div className="relative h-full">
                                ...
                                <h1 className="font-manrope text-white text-4xl font-bold leading-10 absolute top-11 left-11">Liên hệ</h1>
