                ...
                <div className='flex lg:h-[800px] justify-between gap-10'>
                    <div className='h-full lg:flex lg:flex-col w-auto hidden lg:justify-between'>
                        ...
                        <div className='flex gap-5 text-gray-500 font-medium text-sm'>
                            ...
                            <Link className='hover:underline hover:text-gray-800' href={'/policy/privacypolicy'}>Chính sách bảo mật</Link>
                            ...
                            <div className='flex justify-between gap-2'>
                                ...
                                <form onSubmit={e => register(e, appState.agreement, updates)} className="space-y-4 md:space-y-6 flex flex-col gap-4 lg:gap-0">
                                    ...
                                    <div>
                                        ...
                                        <input minLength={4} maxLength={64} required type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nhập họ và tên" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input required type="tel" minLength={10} maxLength={10} pattern="\d{10}" inputMode='numeric' name="mobilenum" id="mobilenum" placeholder="Nhập số điện thoại của bạn" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                                    </div>
                                    <div>
                                        <label className="block mb-2 text-sm font-medium text-gray-900">Ngày sinh</label>
                                        <input required type="date" name="dob" id="dob" placeholder="Nhập ngày sinh" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" />
                                    </div>
                                    <div className="flex flex-col gap-4 justify-between">
                                        <div className="flex items-start">
                                            ...
                                            <div onClick={() => toggleAgreement()} className="ml-3 text-sm font-medium">
                                                <label className="text-gray-500">By signing up, you are creating a H-Comm account, and you agree to H-Comm <a className='text-primary-700 font-medium' href='/policy/terms&conditions'>Điều khoản & Điều kiện</a> and <a className='text-primary-700 font-medium' href='/policy/privacypolicy'>Chính sách bảo mật.</a></label>
                                            </div>
                                        </div>
                                        <div className="flex items-start">
                                            <div className="flex items-center h-5">
                                    ...
                                    <p className="text-sm font-light text-gray-500">
                                        Đã có tài khoản? <Link href="/sign-in" className="font-medium text-primary-600 hover:underline">Đăng nhập</Link>
                                    </p>
                                </form>
                            </div>
                        </div>
