            ...
            <div className="w-full max-w-7xl px-4 md:px-5 lg:px-6 mx-auto">
                <div className="">
                    <h2 className="font-manrope font-bold text-xl sm:text-2xl leading-10 text-black mb-8 text-center">
                        Đánh giá & xếp hạng của khách hàng
                    </h2>
                                ...
                                <div className="col-span-12 md:col-span-8 flex items-center">
                                    <div className="flex flex-col sm:flex-row items-center max-lg:justify-center w-full h-full">
                                        <div
                                            ...
                                            <p className="font-normal leading-8 text-gray-400">{reviewCount} Đánh giá</p>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <p className="font-normal leading-8 text-gray-400">Đánh giá mới nhất</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-span-12 md:col-span-4 max-lg:mt-8 md:pl-8">
                                    <div className="flex items-center flex-col justify-center w-full h-full ">
                                        ...
                                        {!allReview && <Link href={`/all-reviews/${productID}`}><button
                                            className="rounded-full px-4 py-4 bg-white font-semibold text-md text-indigo-600 whitespace-nowrap w-full text-center shadow-sm shadow-transparent transition-all duration-500 hover:bg-indigo-100 hover:shadow-indigo-200">
                                            Xem tất cả đánh giá
                                        </button></Link>}
                                    </div>
                                </div>
                    ...
                    <div className="pb-8 border-b border-gray-200 max-xl:max-w-3xl max-xl:mx-auto">
                        <h4 className="font-manrope font-semibold text-2xl leading-10 text-black mb-6">Đánh giá gần đây</h4>
